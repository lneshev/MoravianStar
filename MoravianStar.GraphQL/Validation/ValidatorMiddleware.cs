...
//                ValidateItem(argument.ContextData, item, context.Services, validationResults);

//                var props = item.GetType().GetProperties(BindingFlags.Public | BindingFlags.Instance).Where(x => !x.GetIndexParameters().Any());
...
//                        {
//                            foreach (var v in (IEnumerable<object>)value)
//                            {
//                                if (v != null)
//                                {
//                                    ValidateItem(argument.ContextData, v, context.Services, validationResults);
//                                }
//                            }
//                        }
//                        else
//                        {
//                            ValidateItem(argument.ContextData, value, context.Services, validationResults);
//                        }
//                    }
//                }
...
//            try
//            {
//                result = result && (context.TryGetValue(nameof(ValidationAttribute), out var attrs) && attrs is IEnumerable<ValidationAttribute> attributes
